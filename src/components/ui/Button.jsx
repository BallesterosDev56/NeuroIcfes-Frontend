...
const Button = ({
  ...
  const baseClasses = 'flex justify-center items-center px-4 py-2 border rounded-md shadow-sm text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200';
  ...
  return (
    <button
      type={type}
      className={`${baseClasses} ${variantClasses[variant][colorScheme]} ${widthClasses}`}
