    ...
    <div className="w-full min-h-screen relative">
      ...
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-16 pt-6 sm:pt-8 md:pt-12 bg-transparent pb-10 sm:pb-12 md:pb-16">
        ...
        <div className="flex items-center mb-6 sm:mb-6 md:mb-8 px-1">
          <div
            className="h-12 w-12 sm:h-10 sm:w-10 md:h-12 md:w-12 rounded-xl flex items-center justify-center"
          >
            <img className='h-10 w-10 sm:h-8 sm:w-9 md:h-10 md:w-11' src={Logo} alt="Logo" />
          </div>
          <h3
